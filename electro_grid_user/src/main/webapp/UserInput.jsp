...
<body>
	...
	<ul>
		<li><a href="tabelView.jsp">Table View</a></li>
		<li><a href="UserInput.jsp">User Registration</a></li>
		<li
			style="float: left; margin-left: 100px; color: white; font-size: 45px;">Electro
			Grid</li>
	</ul>
			...
			<center>
				<div class="row gx-0">
					...
					<div class="col px-5 pt-5 ">
						...
						<center>
							<h1 class="font-weight-bold py-3 mt-2">Registation Form</h1>
						</center>
						<form id="formUser" name="formUser" method="post"
							action="UserInput.jsp">
							<div class="form-row">
								<div class="col">
									<input type="text" id="fName" name="fName"
										class="form-control mt-5 my-4 p-2"
							...
							<div class="form-row">
								<div class="col">
									<input type="email" id="emailId" name="emailId"
										class="form-control mt-5 my-4 p-2" placeholder="Enter Email">
								</div>
							</div>
							<div class="form-row">
								<div class="col">
							...
							<div class="form-row">
								<div class="col">
									<input type="text" id="Nic" name="Nic"
										class="form-control mt-5 my-4 p-2" placeholder="Enter NIC">
								</div>
							</div>
							<div class="form-row">
								<div class="col">
							...
							<div class="form-row">
								<div class="col ">
									<input type="button" class="btn1 mt-3 mb-5" id="btnSave"
										value="Submit">
								</div>
							</div>
						</form>
...
if(id>0){
	$.ajax({
	    url: "http://localhost:8081/electro_grid_user/users/"+id ,
	    type: 'GET',
	    dataType:'json',
...
$(document).ready(function(){
	...
	$('#btnSave').click(function(){
		...
		if(id>0){
			...
			$.ajax({
				url:'http://localhost:8081/electro_grid_user/users/',
				method:'POST',
				data: userObj,
				contentType: 'application/json; charset=utf-8',
				success: function(){
